  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Tagline */}
        <p className="text-sm sm:text-base font-medium text-[--jonquil] mb-4 uppercase tracking-wide drop-shadow-lg">
          {t('tagline')}
        </p>
        ...
        {/* Subheadline */}
        <p className="text-lg sm:text-xl text-white mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-lg">
          {t('subheadline')}
        </p>
        ...
        <div className="mt-12 flex items-center justify-center gap-2 text-[--jonquil]">
          ...
          <span className="text-sm text-white drop-shadow-md">{t('rating')}</span>
        </div>
      </div>
